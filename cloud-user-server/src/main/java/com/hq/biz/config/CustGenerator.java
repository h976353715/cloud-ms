    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
                ...
                new DataSourceConfig()
                        ...
                        .setUsername("root")
                        .setPassword("root")
                        .setUrl("jdbc:mysql://127.0.0.1:3306/hq_account?characterEncoding=utf8")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                        ...
                        // 自定义 controller 父类
                        //.setSuperControllerClass("com.tdx."+filePath+".controller.AbstractController")
